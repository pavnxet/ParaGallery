...
import { fetchUserPhotos, deletePhoto, toggleFavorite, deleteMultiplePhotos, createSharedGallery } from '../lib/db'
import { useAuth } from '../contexts/AuthContext'
import PhotoCard from '../components/PhotoCard'
import PhotoModal from '../components/PhotoModal'
import AlbumList from '../components/AlbumList'
import { Loader2, ArrowLeft, CheckSquare, Trash2, X, Share2, Check } from 'lucide-react'
...
const Gallery = ({ refreshTrigger, searchTerm, activeView }) => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 pb-24">
      ...
      {/* Shared Link Display */}
      {sharedLink && (
          <div className="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 p-4 rounded-lg mb-6 flex flex-col sm:flex-row items-center justify-between gap-4 animate-in fade-in zoom-in duration-300">
      ...
      {isSelectionMode && selectedPhotoIds.size > 0 && (
          <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 bg-white dark:bg-gray-800 shadow-xl rounded-full px-6 py-3 flex items-center gap-6 z-50 border border-gray-200 dark:border-gray-700 animate-in slide-in-from-bottom-5 duration-200">
              ...
              <button
                ...
                disabled={sharing}
                className="text-indigo-600 hover:text-indigo-700 dark:text-indigo-400 dark:hover:text-indigo-300 flex items-center gap-2 whitespace-nowrap disabled:opacity-50"
